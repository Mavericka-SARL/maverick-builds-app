...
Bug reports, documentation errors, questions about self-hosting and feature
requests are all welcome as GitHub issues. A useful report says:

- which snapshot you ran (the commit here) and how you deployed it
...
A security problem is not an issue: follow [SECURITY.md](SECURITY.md) instead.
